...
export declare class ContactsApi {
    ...
    getContactInfo(identifier: string, startDate?: string, endDate?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getContacts(limit?: number, offset?: number, modifiedSince?: string, createdSince?: string, sort?: 'asc' | 'desc', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getList(listId: number, startDate?: string, endDate?: string, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    getSegments(limit: number, offset: number, sort?: 'asc' | 'desc', options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
    ...
    updateBatchContacts(updateBatchContacts: UpdateBatchContacts, options?: {
        headers: {
            [name: string]: string;
        };
    }): Promise<{
